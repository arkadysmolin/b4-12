...
def request_data():
    ...
    gender= input("Введи пол: ")
    email = input("Адрес электронной почты: ")
    birthdate= input("Введи дату рождения в формате ГГГГ-ММ-ДД: ")
    height= input("Введи рост в формате Х.ХХ м: ")
    ...
    print ("Ты ввел:\n Имя: {} \n Дата рождения: {} \n Рост {} м" .format(first_name,birthdate,height))
    return user
